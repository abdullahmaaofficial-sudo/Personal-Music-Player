...
const songs = [
  ...
  { name: "Nonstop Mashup 2025", path: "Music/Nonstop Mashup 2025 _ Talha Anjum, Talwiinder, Atif Aslam ft. Taimour Baig _ Jukebox _ AWAID _ AWAIS.mp4" },
  { name: "AUR - TU HAI KAHAN", path: "Music/AUR - TU HAI KAHAN - Raffey - Usama - Ahad (Official Music Video).mp4" },
  { name: "CHAL DIYE TUM KAHAN ", path: "Music/CHAL DIYE TUM KAHAN - LYRICAL OST - VIDEO SONG - 4K - KABHI MAIN KABHI TUM - MUSTAFA x SHARJEENA.mp4" },
  ...
  { name: "Kaifi Khalil-Kahani Suno 2.0", path: "Music/Kaifi Khalil - Kahani Suno 2.0 [Official Music Video].mp4" },
  ...
  { name: "Talha Anjum,TalhahYunus-DEAR, BELOVED", path: "Music/Umair, Talha Anjum, Talhah Yunus - DEAR, BELOVED (Official Audio).mp4" },
  { name: "Wo Aya Hi Nahi Jo Ek Dafa Gaya", path: "Music/Wo Aya Hi Nahi Jo Ek Dafa Gaya (slow+ reverb) - Shikayat lofi song - Dhun DS.mp4" },
